...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 animate-fade-in">
      <div className="glass-panel rounded-3xl max-w-md w-full p-8 relative overflow-hidden border-indigo-500/20 shadow-2xl">
        {/* Absolute backdrop glow accent */}
        <div className="absolute -left-20 -top-20 w-64 h-64 bg-indigo-500/10 rounded-full blur-3xl pointer-events-none" />

        {/* Brand Shell */}
        <div className="text-center mb-8 relative z-10">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-indigo-500 to-sky-500 flex items-center justify-center mx-auto mb-3 shadow-lg shadow-indigo-500/25 animate-float">
            <Layers className="w-6 h-6 text-white" />
          </div>
          <h1 className="text-2xl font-extrabold text-white tracking-tight">
            Configure <span className="text-gradient">Commander</span>
          </h1>
          <p className="text-xs text-slate-400 mt-1">
            Instantiate your permanent administrative operator profile
          </p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="email"
                required
                placeholder="alex@construction-ai.io"
                value={email}
