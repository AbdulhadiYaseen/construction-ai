    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="relative overflow-hidden rounded-3xl p-8 bg-[#0b0f19] border border-white/10 flex flex-col md:flex-row items-center md:items-center justify-between gap-6 group mb-2">
        ...
        <div className="relative z-10 text-center md:text-left">
          ...
          <p className="text-xs text-slate-300 mt-1.5 max-w-md">
            Complete directory of all your active, planning, and completed construction projects.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="glass-panel rounded-2xl p-16 text-center max-w-md mx-auto mt-8">
          ...
          <h3 className="font-bold text-sm text-slate-300">No Projects Matched</h3>
